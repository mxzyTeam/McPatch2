  ...
  return (
    <>
      <div className="p-10 min-h-screen">
        <div className="text-2xl font-bold text-[#5a7d8f] dark:text-[#D4AF37]">磁盘使用量</div>
        <div className='neu-progress-track h-8 mt-4 mb-2 w-full relative'>
          <div
        ...
        <div className="text-base flex justify-end items-center w-full text-[#636e72] dark:text-[#9E8E6E]">
